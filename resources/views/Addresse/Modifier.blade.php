    ...
    <div class="col-6">
        <div class="border border-info card ">
            <div class="card-header text-white bg-info">
                <h3 class="display1 text-center font-weight-bold ">Modifier addresse </h3>
            </div>
            <div class="card-body">
                <br>
                <form action="/Addresse/Modifier" method="post" class="needs-validation" novalidate>
                    @csrf
                    <div class="form-row">
                            ...
                            <select class="custom-select form-control" id="EntrepriseID" name="EntrepriseID" required>
                                @foreach ($listEntreprise as $item)
                                    @if ($item->EntrepriseID == $addresse->EntrepriseID)
                                        <option value="{{ $item->EntrepriseID }}" selected>{{ $item->EntrepriseName }}
                                        </option>
                                    @else
                            ...
                            <select class="custom-select form-control" id="AddressTypeID" name="AddressTypeID" required>
                                @foreach ($listAddresseType as $item)
                                    @if ($item->AddressTypeID == $addresse->AddressTypeID)
                                        <option value="{{ $item->AddressTypeID }}" selected>{{ $item->AddressType }}
                                        </option>
                                    @else
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="AddressLine1" name="AddressLine1"
                                value="{{ $addresse->AddressLine1 }}" required>
                            <div class="invalid-feedback ">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="Country" id="Country" required>
                                <option value="{{ $addresse->Country }}" selected>{{ $addresse->Country }}</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="Province" id="Province" required>
                                <option value="{{ $addresse->Province }}" selected>{{ $addresse->Province }}</option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="PostalCode" name="PostalCode"
                                value="{{ $addresse->PostalCode }}" required>
                            <div class="invalid-feedback ">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="WebSiteURL" name="WebSiteURL"
                                value="{{ $addresse->WebSiteURL }}" required>
                            <div class="invalid-feedback ">
                                Veuillez entrer l'URL site web
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="id" name="id" value="{{ $addresse->AddressID }}">
                    <br>
